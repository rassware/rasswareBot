...
#run 2 mins for data
#/usr/bin/timeout 120 /home/crassmann/scripts/raspi/rtlclient.sh -f 433920000 -a 192.168.78.28 -p 1234 -s 250000 | /usr/local/bin/rtl_433 -F csv -G -U -r /dev/stdin > /mnt/1und1/transfer/sensors.csv
#/usr/local/bin/rtl_433 -F csv -T 120 -p -32 > /mnt/1und1/transfer/sensors.csv

# import file to database
echo -e "DROP TABLE IF EXISTS import_sensors;" | sqlite3 /home/crassmann/databases/climadb.db
echo -e ".separator ","\n.import /home/crassmann/transfer/sensors.csv import_sensors" | sqlite3 /home/crassmann/databases/climadb.db

# make csv file blank
#echo "" > /mnt/1und1/transfer/sensors.csv
...
rm /home/crassmann/transfer/sensors.csv
